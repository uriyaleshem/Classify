...
def prettify_message(message: str) -> str:
    ...
    mapping = {
        ...
        'LOGIN_RATE_LIMITED': 'Too many failed sign-in attempts from this network. Please try again later.',
        ...
        'FILE_REJECTED_MALWARE': 'This file was blocked by the server security scan.',
        'FILE_SCAN_UNAVAILABLE': 'The server could not scan this file for viruses right now.',
        'FILE_SCAN_FAILED': 'The server security scan failed. Please try again later.',
